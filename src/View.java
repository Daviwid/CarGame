...
//             }
    ...
    public void drawCar(Graphics2D g2d, Car car) {
		...
		Image resultingImage = car.getCarIMG().getScaledInstance(car.getWidth(), car.getHeight(), Image.SCALE_DEFAULT);
	    BufferedImage outputImage = new BufferedImage(car.getWidth(), car.getHeight(), BufferedImage.TYPE_INT_ARGB);
...
//        AffineTransform a = AffineTransform.getRotateInstance(car.getAngle(), car.getPositionX(), car.getPositionY());
       ...
       g2d.rotate(car.getAngle() + (3*Math.PI)/2, car.getPositionX(), car.getPositionY());
        ...
        g2d.drawImage(outputImage, car.getPositionX() - 10, car.getPositionY()-20 , null);
//      g2d.setTransform(a); 
